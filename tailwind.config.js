  ...
  theme: {
    extend: {
      colors: {
        ...
        // Tiyatronot Handoff Design Tokens (Dynamic with CSS Variables for Dark Mode)
        tn: {
          red: 'var(--tn-red, #BA1B23)',
          ink: 'var(--tn-ink, #1C1A1B)',
          page: 'var(--tn-page, #E9E4DC)',
          container: 'var(--tn-container-bg, #FFFFFF)',
          surface: 'var(--tn-surface, #F1EDE7)',
          card: 'var(--tn-card, #F6F3EE)',
          ticket: 'var(--tn-ticket, #FFFCF7)',
          line: 'var(--tn-line, #E2DCD4)',
          'line-strong': 'var(--tn-line-strong, #D8D2CA)',
          border: 'var(--tn-line, #E2DCD4)',
          blush: 'var(--tn-blush, #F4D3CE)',
          sage: 'var(--tn-sage, #D6E0D3)',
          sand: 'var(--tn-sand, #F1E3C4)',
          'sand-light': 'var(--tn-sand-light, #FAF1DD)',
          lilac: 'var(--tn-lilac, #D9CFF2)',
          'lilac-strong': 'var(--tn-lilac-strong, #CFC3F1)',
          'lilac-stripe': 'var(--tn-lilac-stripe, #C0B2EA)',
          ochre: 'var(--tn-ochre, #E4B33A)',
          text: 'var(--tn-text, #1C1A1B)',
          'text-2': 'var(--tn-text-2, #4A4541)',
          'text-3': 'var(--tn-text-3, #5E5852)',
          muted: 'var(--tn-text-muted, #6E6862)',
          faint: 'var(--tn-text-faint, #9A928A)',
          'on-dark-muted': 'var(--tn-text-on-dark-muted, #B8B0A8)',
        },
      },
      fontFamily: {
