...
export const StickyActionBar: React.FC<StickyActionBarProps> = ({
  ...
  return (
    <div
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-tn-surface/95 backdrop-blur-md border-t border-tn-line px-4 py-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom))] shadow-[0_-4px_20px_rgba(0,0,0,0.15)] flex justify-between items-center font-serif text-tn-text"
    >
